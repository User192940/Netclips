...
const Login = () => {
  ...
  return (
    ...
    <div className='w-full h-screen'>
        <img className='block absolute w-full h-full object-cover' src='https://assets.nflxext.com/ffe/siteui/vlv3/dc1cf82d-97c9-409f-b7c8-6ac1718946d6/a6fda18c-4665-445a-9988-12e2871a59ee/US-en-20230911-popsignuptwoweeks-perspective_alpha_website_large.jpg' alt=''/>
